...
export default function SettingsForm() {
    const { theme, setTheme, rememberMe, setRememberMe,
        showNotifications, setShowNotifications } = useSiteSettings();
    const {
        register,
        handleSubmit,
        formState: { errors }
    ...
    const onSubmit = (data: SettingsForm) => {
        ...
        if (data.session !== rememberMe) {
            setRememberMe(data.session)
        }
        if (data.notifications !== showNotifications) {
            setShowNotifications(data.notifications);
        }
